...
export const popularCities: City[] = [
  ...
  {
    name: 'Hyderabad',
    image: 'https://images.unsplash.com/photo-1560237606-f82b6cb1ebbf?auto=format&fit=crop&w=800&q=80',
    state: 'Telangana'
  },
  {
    name: 'Varanasi',
    image: 'https://images.unsplash.com/photo-1614164974666-057a7c713ba6?q=80&w=1740&auto=format&fit=crop&w=800&q=80',
    state: 'Uttar Pradesh'
  },
  {
    name: 'Udaipur',
